...
<div id="contenido">    
    <!--Formulario - Ingresar datos-->
     <form action="historial.php" method="post" onSubmit="return validar();" name="formulario">
    ...
    <!--Video-->
    <div class="video">
       <p style="clear: left; text-align: left; color: #00374C; font-family: century_gothic; font-size: 16px; padding-top: 32px;"><br/> Apreciado estudiante de licenciaturas consulte si historial académico, materias homologadas, cursadas, materias programadas y materias pendientes por cursar. Para ello debe ingresar su código de Banner o código de estudiante (número de 9 dígitos que inicia con 1000 o 9000).<br /><br />
Recuerde que la información suministrada por este sistema es de carácter informativo.
.</p>
